...
output_file = 'plot/tf_time.pdf'

objects = ('Single-thread\nRead', 'SystemX\n1 node', 'SystemX\n8 node',
'Spark\n8 nodes read')
offset = 0.3
width = 0.25       # the width of the bars
y_pos = np.arange(len(objects)) + offset
vals = (813.75, 302.5, 43.96, 33.025)

barlist = plt.bar(y_pos, vals, width, align='center', color=tableau_colors['green'])
...
plt.xticks(size=20)
plt.yticks(size=20)
plt.ylabel('Load Time (seconds)', fontsize=20)
